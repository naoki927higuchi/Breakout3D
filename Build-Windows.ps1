...
if (-not (Test-Path -LiteralPath $UnityEditor)) { throw 'Unity Editor not found. Pass -UnityEditor with the path to Unity.exe.' }
...
$gamePath = Join-Path $PSScriptRoot 'Builds\Windows\NeonBreak.exe'
